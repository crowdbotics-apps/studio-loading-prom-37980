...
## Project Structure
    ...
    ├── studio_loading_prom_37980  # Django project configurations
...
1. Clone this repo and `cd studio_loading_prom_37980`
...
2. Clone this repo and `cd studio_loading_prom_37980`
